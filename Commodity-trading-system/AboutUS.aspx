<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InfoSupplierHome.aspx.cs" Inherits="InfoSupplierHome" %>
...
border=0>
                          ...
                          <TR>
                            <TD vAlign=bottom style="height: 31px"><IMG height=28 
                              src="images/bullet.jpg" width=26></TD>
                            <TD style="height: 31px"><A 
                ...
                <TD style="background-color: lemonchiffon; width: 581px; height: 480px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="19px" Style="z-index: 100; left: 494px; position: absolute; top: 181px"
                        Text="About US " Width="124px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                ...
                <TD background=images/footbg.jpg height=42 style="background-image: url(images/but_bg.jpg)">
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD class=footer style="background-image: url(images/but_bg.jpg)"><a href="Home.aspx"> Home </a> |<a href="AboutUS.aspx">  About Us </a> | <a href="AboutCIS.aspx">  About CIS </a>  | <a href="Samples.aspx">  Samples </a> | <a href="CustomerReg.aspx">
                        Register </a> | <a href="Info_Supplier.aspx">  Infosupply </a> | <a href="Contactus.aspx">  Contact Us </a></td></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></BODY></HTML>
