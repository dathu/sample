<%@ Page Language="C#" AutoEventWireup="true" CodeFile="msstate.aspx.cs" Inherits="msstate" %>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 487px; position: absolute; top: 232px"
                        Text="State Master" Width="108px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp;
                       <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 101;
                           left: 344px; position: absolute; top: 188px">My Page</asp:HyperLink>
                       &nbsp;&nbsp;
                       <asp:Label ID="Label4" runat="server" ForeColor="Maroon" Style="z-index: 102; left: 441px;
                           position: absolute; top: 276px" Text="State Name *" TabIndex="5"></asp:Label>
                       &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:TextBox ID="txtStName" runat="server" Style="z-index: 103; left: 534px; position: absolute;
                        top: 275px" Height="19px" Width="131px" MaxLength="29"></asp:TextBox>
                       &nbsp; &nbsp;
                       &nbsp; &nbsp;
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 104; left: 535px; position: absolute;
                           top: 314px" Text="Submit" OnClick="btnSubmit_Click" TabIndex="2" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 105; left: 610px; position: absolute;
                           top: 312px" Text="Clear" OnClick="btnClear_Click" TabIndex="3" />
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtStName"
                           ErrorMessage="Enter State Name" Style="z-index: 106; left: 418px; position: absolute;
                           top: 390px" Width="184px"></asp:RequiredFieldValidator>
                       <asp:Label ID="Label2" runat="server" ForeColor="Red" Style="z-index: 108; left: 311px;
                           position: absolute; top: 361px" Text="Label" Width="399px"></asp:Label>
                        </form>
                </TD>
