<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mandalview.aspx.cs" Inherits="mandalview" %>
...
<TABLE cellSpacing=0 cellPadding=0 width=775 align=center border=0>
  <TBODY>
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px; width: 745px;">
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 606px;">&nbsp;
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT [LocID], [StateID], [DistID], [MandID], [Name1] FROM [Loc_Mast] WHERE ([Loc_TypeID] = @Loc_TypeID)" DeleteCommand="DELETE FROM Loc_Mast where LocID=@LocID" UpdateCommand="update Loc_Mast set StateID=@StateID,DistID=@DistID,MandID=@MandID,Name1=@Name1 where LocID=@LocID">
            <SelectParameters>
                <asp:Parameter DefaultValue="3" Name="Loc_TypeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 480px; position: absolute; top: 178px"
                        Text="Edit / View   Mandal " Width="133px" Font-Underline="True" TabIndex="6"></asp:Label>&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="LocID"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 304px; position: absolute;
            top: 220px" AllowPaging="True">
             <Columns>
             ...
             <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 689px; position: absolute; top: 195px">Home</asp:LinkButton>
                        </form>
                </TD>
