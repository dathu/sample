<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MrkCommView.aspx.cs" Inherits="MrkCommView" %>
                ...
                <TD style="background-color: lemonchiffon; width: 580px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="19px" Style="z-index: 100; left: 459px; position: absolute; top: 168px"
                        Text="MARKET   COMMODITY VIEW" Width="231px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; 
                      <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx"
                          Style="z-index: 103; left: 645px; position: absolute; top: 205px" Width="60px">My Page</asp:LinkButton>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>"
                          DeleteCommand="DELETE FROM Market_Comm where CommID=@CommID" SelectCommand="SELECT * FROM [Market_Comm]"
                          UpdateCommand="UPDATE Market_Comm SET MarketID = @MarketID, MRK_COMM_MSR = @MRK_COMM_MSR WHERE (CommID = @CommID)">
                      </asp:SqlDataSource>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      ...
                      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                          ...
                          position: absolute; top: 248px" Width="166px" DataKeyNames="CommID">
                          <Columns>
                              <asp:BoundField DataField="CommID" HeaderText="CommID" SortExpression="CommID" />
                              <asp:BoundField DataField="MarketID" HeaderText="MarketID" SortExpression="MarketID" />
                              <asp:BoundField DataField="MRK_COMM_MSR" HeaderText="MRK_COMM_MSR" SortExpression="MRK_COMM_MSR" />
