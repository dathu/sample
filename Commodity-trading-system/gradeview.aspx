<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gradeview.aspx.cs" Inherits="gradeview" %>
...
<TABLE cellSpacing=0 cellPadding=0 width=775 align=center border=0>
  <TBODY>
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px; width: 768px;">
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 606px;">&nbsp;
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT [CommID], [CatID], [NameID], [TypeID], [GradeID], [Name1] FROM [Comm_Mast] WHERE ([Comm_Div_TypeID] = @Comm_Div_TypeID2)" DeleteCommand="DELETE FROM Comm_Mast WHERE (CommID = @CommID)" UpdateCommand="UPDATE Comm_Mast SET CatID = @CatID, NameID = @NameID, TypeID = @TypeID,GradeID=@GradeID, Name1 = @Name1 WHERE (CommID = @CommID)">
            <SelectParameters>
                <asp:Parameter DefaultValue="4" Name="Comm_Div_TypeID2" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="Edit / View  Grade" Width="133px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 313px; position: absolute;
            top: 219px" AllowPaging="True" DataKeyNames="CommID">
            <Columns>
                ...
                <asp:CommandField ShowDeleteButton="True" />
                       ...
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 765px; position: absolute; top: 193px">Home</asp:LinkButton>
                        </form>
                </TD>
