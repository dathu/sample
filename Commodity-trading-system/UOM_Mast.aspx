<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UOM_Mast.aspx.cs" Inherits="UOM_Mast" %>
...
>
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 100;
        left: 341px; position: absolute; top: 172px" TabIndex="6">My Page</asp:HyperLink>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 580px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="19px" Style="z-index: 100; left: 462px; position: absolute; top: 168px"
                        Text="UNIT OF MEASUREMENT" Width="201px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                      <asp:Label ID="Label11" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 101;
                          left: 401px; position: absolute; top: 269px" Text="Measure Standard *" Width="125px"></asp:Label>
                      <asp:Label ID="Label2" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 102;
                          left: 401px; position: absolute; top: 306px" Text="Value of Measure *"
                          Width="123px"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;
                      <asp:Label ID="Label16" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 103;
                          left: 403px; position: absolute; top: 231px" Text="Measure Name *" Width="111px"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp;&nbsp;
                      <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Style="z-index: 104;
                          left: 541px; position: absolute; top: 354px" Text="Submit" TabIndex="4" />
                      &nbsp;
                      <asp:Button ID="btnCancel" runat="server" Style="z-index: 105; left: 620px; position: absolute;
                          top: 354px" Text="Cancel" OnClick="btnCancel_Click" TabIndex="5" />
                      &nbsp; &nbsp;
                      <asp:TextBox ID="txtMsrValue" runat="server" Height="22px" Style="z-index: 106;
                          left: 541px; position: absolute; top: 307px" Width="129px" MaxLength="3" TabIndex="2"></asp:TextBox>
                      <asp:TextBox ID="txtMsrName" runat="server" Height="22px" Style="z-index: 107; left: 543px;
                          position: absolute; top: 232px" Width="129px" MaxLength="25"></asp:TextBox>
                      <asp:TextBox ID="txtMsrStan" runat="server" Height="22px" Style="z-index: 108; left: 542px;
                          position: absolute; top: 269px" Width="129px" MaxLength="25" TabIndex="1"></asp:TextBox>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMsrStan"
                          ErrorMessage="Measure of Unit Standard Should not be empty" Style="z-index: 109;
                          left: 412px; position: absolute; top: 483px" Width="321px"></asp:RequiredFieldValidator>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtMsrValue"
                          ErrorMessage="Enter Value " Style="z-index: 110; left: 504px; position: absolute;
                          top: 450px" Width="196px"></asp:RequiredFieldValidator>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtMsrName"
                          ErrorMessage="Enter Measure Name" Height="20px" Style="z-index: 111; left: 498px;
                          position: absolute; top: 416px" Width="195px"></asp:RequiredFieldValidator>
                      <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtMsrValue"
                          ErrorMessage="Value of Measure Should be in Numbers" Style="z-index: 113; left: 400px;
                          position: absolute; top: 510px" Width="328px" ValidationExpression="\d{1,3}"></asp:RegularExpressionValidator>
                </form>
                </TD>
                <TD style="width: 4px"><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD class=footer style="background-image: url(images/but_bg.jpg)"><a href="Home.aspx"> Home </a> |Aboutus | About CIS | Samples | <a href="CustomerReg.aspx">
                        Register </a> | <a href="Info_Supplier.aspx">  Infosupply </a> | Contact</td></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></BODY></HTML>
