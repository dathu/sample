<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cityview.aspx.cs" Inherits="cityview" %>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 571px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="Edit / View  City" Width="147px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT [CityID], [Name1] FROM [City_Mast]" DeleteCommand="DELETE FROM City_Mast WHERE (CityID = @CityID)" UpdateCommand="UPDATE City_Mast SET Name1 = @Name1 WHERE (CityID = @CityID)">
        </asp:SqlDataSource>
                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CityID"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 480px; position: absolute;
            top: 235px" AllowPaging="True" Width="214px">
            <Columns>
                ...
                <asp:CommandField ShowDeleteButton="True" />
                       ...
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 655px; position: absolute; top: 211px">Home</asp:LinkButton>
                        </form>
                </TD>
