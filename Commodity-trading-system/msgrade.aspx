<%@ Page Language="C#" AutoEventWireup="true" CodeFile="msgrade.aspx.cs" Inherits="msgrade" %>
...
>
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 100;
        left: 300px; position: absolute; top: 187px">My Page</asp:HyperLink>
    <asp:Label ID="Label4" runat="server" ForeColor="Red" Style="z-index: 102; left: 402px;
        position: absolute; top: 393px" Text="Label" Width="330px"></asp:Label>
                ...
                <TD style="background-color: lemonchiffon">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 512px; position: absolute; top: 177px"
                        Text="Grade  Master" Width="110px" Font-Underline="True"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" ForeColor="Maroon" Style="z-index: 101; left: 438px;
                        position: absolute; top: 237px" Text="Category ID *"></asp:Label>
                       <asp:Label ID="Label2" runat="server" ForeColor="Maroon" Style="z-index: 102; left: 440px;
                           position: absolute; top: 262px" Text="Name ID *"></asp:Label>
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp;&nbsp;
                       <asp:DropDownList ID="ddlCatID" runat="server" Style="z-index: 103; left: 554px; position: absolute;
                           top: 235px" Width="136px" Height="19px" AutoPostBack="True" OnSelectedIndexChanged="ddlCatID_SelectedIndexChanged">
                       </asp:DropDownList>
                       <asp:DropDownList ID="ddlNameID" runat="server" Style="z-index: 104; left: 553px; position: absolute;
                           top: 261px" Width="136px" Height="19px" AutoPostBack="True" OnSelectedIndexChanged="ddlNameID_SelectedIndexChanged">
                       </asp:DropDownList>
                       <asp:Label ID="Label7" runat="server" ForeColor="Maroon" Style="z-index: 105; left: 440px;
                           position: absolute; top: 313px" Text="Grade  Name *"></asp:Label>
                       <asp:TextBox ID="txtGradeName" runat="server" Style="z-index: 106; left: 553px; position: absolute;
                           top: 314px" Height="19px" Width="136px"></asp:TextBox>
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 107; left: 551px; position: absolute;
                           top: 349px" Text="Submit" OnClick="btnSubmit_Click" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 108; left: 630px; position: absolute;
                           top: 349px" Text="Clear" OnClick="btnClear_Click" />
                       <asp:Label ID="Label3" runat="server" ForeColor="Maroon" Style="z-index: 109; left: 441px;
                           position: absolute; top: 287px" Text="Type ID *"></asp:Label>
                       <asp:DropDownList ID="ddlTypeID" runat="server" Height="19px" Style="z-index: 110;
                           left: 554px; position: absolute; top: 287px" Width="136px">
                       </asp:DropDownList>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtGradeName"
                           ErrorMessage="Enter Grade Name" Style="z-index: 112; left: 514px; position: absolute;
                           top: 425px" Width="211px"></asp:RequiredFieldValidator>
                        </form>
                </TD>
                <TD width=14><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
