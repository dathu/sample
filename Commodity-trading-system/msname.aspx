<%@ Page Language="C#" AutoEventWireup="true" CodeFile="msname.aspx.cs" Inherits="msname" %>
...
>
    <asp:Label ID="Label2" runat="server" ForeColor="Red" Style="z-index: 100; left: 299px;
        position: absolute; top: 351px" Text="Label" Width="355px"></asp:Label>
<TABLE cellSpacing=0 cellPadding=0 width=775 align=center border=0>
  <TBODY>
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px; width: 737px;">
        ...
        <TR>
          <TD style="height: 492px">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR vAlign=top>
                <TD width=180 background=images/but_bg.jpg style="background-image: url(images/but_bg.jpg); height: 489px;"><TABLE cellSpacing=0 cellPadding=0 width=165 
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 775px; height: 489px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 517px; position: absolute; top: 182px"
                        Text="Name Master" Width="108px" Font-Underline="True" TabIndex="8"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" ForeColor="Maroon" Style="z-index: 101; left: 459px;
                        position: absolute; top: 234px" Text="Category ID *" TabIndex="5" Width="103px" Height="21px"></asp:Label>
                       &nbsp;
                       <asp:Label ID="Label4" runat="server" ForeColor="Maroon" Style="z-index: 102; left: 463px;
                           position: absolute; top: 266px" Text=" Name *" TabIndex="7" Width="65px"></asp:Label>
                       &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:TextBox ID="txtName" runat="server" Style="z-index: 103; left: 574px; position: absolute;
                        top: 266px" Height="19px" Width="131px" TabIndex="2" MaxLength="25"></asp:TextBox>
                       <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 104;
                           left: 368px; position: absolute; top: 184px">My Page</asp:HyperLink>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
                           ErrorMessage="Enter Name" Style="z-index: 109; left: 480px; position: absolute;
                           top: 379px" Width="193px"></asp:RequiredFieldValidator>
                       &nbsp; &nbsp;&nbsp;
                       <asp:DropDownList ID="ddlCatID" runat="server" Style="z-index: 106; left: 573px;
                           position: absolute; top: 235px" Width="134px">
                       </asp:DropDownList>
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 107; left: 576px; position: absolute;
                           top: 306px" Text="Submit" OnClick="btnSubmit_Click" TabIndex="3" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 108; left: 651px; position: absolute;
                           top: 306px" Text="Clear" OnClick="btnClear_Click" TabIndex="4" />
                        </form>
                </TD>
                <TD style="width: 12px; height: 489px;"><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
