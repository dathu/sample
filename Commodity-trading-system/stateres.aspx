<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stateres.aspx.cs" Inherits="stateres" %>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       ...
                       <asp:Button ID="btnHome" runat="server" Style="z-index: 102; left: 455px; position: absolute;
