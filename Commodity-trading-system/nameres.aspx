<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nameres.aspx.cs" Inherits="nameres" %>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp;
                       <asp:Button ID="btnYes" runat="server" Style="z-index: 101; left: 397px; position: absolute;
                           top: 264px" Text="Yes" OnClick="btnYes_Click" Width="42px" />
                       <asp:Button ID="btnHome" runat="server" Style="z-index: 102; left: 467px; position: absolute;
