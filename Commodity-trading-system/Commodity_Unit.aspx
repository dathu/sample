<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Commodity_Unit.aspx.cs" Inherits="Commodity_Unit" %>
                ...
                <TD style="background-color: lemonchiffon; width: 580px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="19px" Style="z-index: 100; left: 464px; position: absolute; top: 172px"
                        Text="COMMODITY UNIT" Width="163px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                      <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 108;
                          left: 317px; position: absolute; top: 174px">My Page</asp:HyperLink>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                      <asp:DropDownList ID="ddlMsr_ID" runat="server" Style="z-index: 102; left: 548px;
                          position: absolute; top: 238px" Height="22px" Width="121px">
                      </asp:DropDownList><asp:DropDownList ID="ddlCATID" runat="server" Style="z-index: 103; left: 549px;
                          position: absolute; top: 266px" Width="121px" Height="22px">
                      </asp:DropDownList>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      ...
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                      <asp:Label ID="Label11" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 104;
                          left: 432px; position: absolute; top: 268px" Text="Category ID *" Width="96px"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;
                      <asp:Label ID="Label16" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 105;
                          left: 432px; position: absolute; top: 241px" Text="Measure ID *" Width="93px"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp;&nbsp;
                      <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Style="z-index: 106;
                          left: 550px; position: absolute; top: 312px" Text="Register" />
                      &nbsp;
                      <asp:Button ID="btnCancel" runat="server" Style="z-index: 107; left: 627px; position: absolute;
                          top: 312px" Text="Cancel" />
                      &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                </form>
                </TD>
