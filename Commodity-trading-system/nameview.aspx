<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nameview.aspx.cs" Inherits="nameview" %>
                ...
                <TD style="background-color: lemonchiffon; width: 606px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 488px; position: absolute; top: 187px"
                        Text="Edit / View Name" Width="126px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; 
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" 
                       DeleteCommand="DELETE FROM Comm_Mast WHERE (CommID = @CommID)" 
                       UpdateCommand="UPDATE Comm_Mast SET CatID = @CatID,NameID=@NameID, Name1 = @Name1 WHERE (CommID = @CommID)" SelectCommand="SELECT [CommID], [CatID], [NameID], [Name1] FROM [Comm_Mast] WHERE ([Comm_Div_TypeID] = @Comm_Div_TypeID)">
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="Comm_Div_TypeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp;
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 101;
                           left: 686px; position: absolute; top: 218px">Home</asp:LinkButton>
                       &nbsp;
                       <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                           DataKeyNames="CommID" DataSourceID="SqlDataSource1" Style="z-index: 103; left: 375px;
