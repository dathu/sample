<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Market_Price.aspx.cs" Inherits="msPrice" %>
  ...
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px;">
      ...
      background=images/headbg.jpg border=0>
        <TBODY>
        <TR>
          <TD width=224 style="background-image: url(images/headbg.jpg); height: 125px;">
          ...
          <TD width=537 style="background-image: url(images/headbg.jpg); height: 125px;">&nbsp;</TD>
          <TD width=14 style="height: 125px"><IMG height=1 src="images/spacer.gif" 
        ...
        <TR>
          <TD style="height: 492px">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR vAlign=top>
                <TD background=images/but_bg.jpg 
                  height=473 style="background-image: url(images/but_bg.jpg); width: 180px;"><TABLE cellSpacing=0 cellPadding=0 width=165 
                ...
                <TD style="background-color: lemonchiffon; width: 580px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="19px" Style="z-index: 100; left: 531px; position: absolute; top: 167px"
                        Text="MARKET PRICE" Width="128px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                      <asp:TextBox ID="txtInfoSupplierID" runat="server" Style="z-index: 115; left: 642px; position: absolute;
                          top: 228px" Width="123px"></asp:TextBox>
                      <asp:SqlDataSource
                          ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>"
                          SelectCommand="SELECT [MSR_Name] FROM [UOM_Mast]"></asp:SqlDataSource>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      ...
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                      <asp:Button ID="btnCancel" runat="server" Style="z-index: 102; left: 703px; position: absolute;
                          top: 297px" Text="Cancel" Width="58px" OnClick="btnCancel_Click" />
                      &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                      <asp:Label ID="Label2" runat="server" ForeColor="Navy" Style="z-index: 103; left: 299px;
                          position: absolute; top: 233px" Text="Market ID"></asp:Label>
                      <asp:Label ID="Label3" runat="server" ForeColor="Navy" Style="z-index: 104; left: 528px;
                          position: absolute; top: 260px" Text="Time"></asp:Label>
                      <asp:Label ID="Label4" runat="server" ForeColor="Navy" Style="z-index: 105; left: 529px;
                          position: absolute; top: 232px" Text="Info Supplier ID" Width="100px"></asp:Label>
                      <asp:Label ID="Label5" runat="server" ForeColor="Navy" Style="z-index: 106; left: 302px;
                          position: absolute; top: 262px" Text="Date"></asp:Label>
                      &nbsp;
                      <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged"
                          Style="z-index: 107; left: 775px; position: absolute; top: 136px"></asp:Calendar>
                      <asp:TextBox ID="txtDate" runat="server" Height="21px" Style="z-index: 108; left: 382px;
                          position: absolute; top: 260px" Width="102px"></asp:TextBox>
                      <asp:TextBox ID="txtTime" runat="server" Height="21px" Style="z-index: 109; left: 640px;
                          position: absolute; top: 258px" Width="102px" Columns="10"></asp:TextBox>
                      &nbsp;
                      <asp:Button ID="Button3" runat="server" Font-Bold="True" Height="25px" OnClick="Button3_Click"
                          Style="z-index: 111; left: 483px; position: absolute; top: 258px" Text=".." Width="25px" />
                      <asp:Button ID="btnSubmit" runat="server" OnClick="btnSubmit_Click" Style="z-index: 112;
                          left: 624px; position: absolute; top: 297px" Text="Submit" />
                      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                          Style="z-index: 113; left: 298px; position: absolute; top: 327px" Width="1px">
                          <Columns>
                              ...
                              <asp:TemplateField>
                                  ...
                                  <ItemTemplate>
                                      <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" DataSourceID="SqlDataSource2"
                                          DataTextField="MSR_Name" DataValueField="MSR_Name" Width="90px">
                                      </asp:DropDownList>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              <asp:TemplateField>
                      ...
                      <asp:DropDownList ID="ddlMarket" runat="server" AutoPostBack="True" Height="21px"
                          OnSelectedIndexChanged="ddlMarket_SelectedIndexChanged" Style="z-index: 114;
                          left: 383px; position: absolute; top: 229px" Width="122px">
                      </asp:DropDownList>
                      &nbsp;
                </form>
                </TD>
                <TD style="width: 9px"><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
