<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UOMView.aspx.cs" Inherits="UOMView" %>
                ...
                <TD style="background-color: lemonchiffon; width: 580px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="19px" Style="z-index: 100; left: 442px; position: absolute; top: 168px"
                        Text="UNIT OF MEASUREMENT VIEW" Width="248px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; 
                      <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx"
                          Style="z-index: 103; left: 683px; position: absolute; top: 225px" Width="45px">Home</asp:LinkButton>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT * FROM [UOM_Mast]">
                      </asp:SqlDataSource>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      ...
                      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                          DataSourceID="SqlDataSource1" Height="59px" Style="z-index: 102; left: 318px;
                          position: absolute; top: 248px" Width="166px">
                          <Columns>
                              <asp:BoundField DataField="MSR_ID" HeaderText="MSR_ID" ReadOnly="True" SortExpression="MSR_ID" />
                              <asp:BoundField DataField="MSR_Name" HeaderText="MSR_Name" ReadOnly="True" SortExpression="MSR_Name" />
                              <asp:BoundField DataField="MSR_STAN" HeaderText="MSR_STAN" ReadOnly="True" SortExpression="MSR_STAN" />
                              <asp:BoundField DataField="MSR_Value" HeaderText="MSR_Value" ReadOnly="True" SortExpression="MSR_Value" />
                          </Columns>
                      </asp:GridView>
                      &nbsp;
                </form>
