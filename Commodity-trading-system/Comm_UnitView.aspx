<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Comm_UnitView.aspx.cs" Inherits="Comm_UnitView" %>
                ...
                <TD style="background-color: lemonchiffon; width: 580px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="COMMODITY UNIT VIEW" Width="203px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; 
                      <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx"
                          Style="z-index: 103; left: 613px; position: absolute; top: 224px" Width="45px">Home</asp:LinkButton>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT * FROM [COMM_UNIT]" DeleteCommand="DELETE FROM COMM_UNIT  WHERE (MSR_ID = @MSR_ID)" UpdateCommand="UPDATE COMM_UNIT SET CatID = @CatID WHERE (MSR_ID = @MSR_ID)">
                      </asp:SqlDataSource>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      ...
                      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                          DataSourceID="SqlDataSource1" Height="59px" Style="z-index: 102; left: 441px;
                          position: absolute; top: 248px" Width="166px" DataKeyNames="MSR_ID">
                          <Columns>
                              <asp:BoundField DataField="MSR_ID" HeaderText="MSR_ID" SortExpression="MSR_ID" />
