<%@ Page Language="C#" AutoEventWireup="true" CodeFile="villageview.aspx.cs" Inherits="villageview" %>
...
<TABLE cellSpacing=0 cellPadding=0 width=775 align=center border=0>
  <TBODY>
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px; width: 764px;">
  ...
  <TR>
    <TD style="width: 764px">
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD style="width: 792px"><IMG height=5 src="images/spacer.gif" width=1></TD></TR>
        <TR>
          <TD style="height: 492px; width: 792px;">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR vAlign=top>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 606px;">&nbsp;
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT [LocID], [StateID], [DistID], [MandID], [VilID], [Name1] FROM [Loc_Mast] WHERE ([Loc_TypeID] = @Loc_TypeID)" DeleteCommand="DELETE FROM Loc_Mast where LocID=@LocID" UpdateCommand="update Loc_Mast set StateID=@StateID,DistID=@DistID,MandID=@MandID,VilID=@VilID,Name1=@Name1 where LocID=@LocID">
            <SelectParameters>
                <asp:Parameter DefaultValue="4" Name="Loc_TypeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 473px; position: absolute; top: 178px"
                        Text="Edit / View   Village " Width="133px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
                       ...
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="LocID"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 234px; position: absolute;
            top: 229px" AllowPaging="True">
            <Columns>
                ...
                <asp:BoundField DataField="DistID" HeaderText="DistrictID" />
                <asp:BoundField DataField="MandID" HeaderText="MandalID" />
                <asp:BoundField DataField="VilID" HeaderText="VilID" />
                <asp:BoundField DataField="Name1" HeaderText="Name1" SortExpression="Name1" />
                <asp:CommandField ShowEditButton="True" />
                <asp:CommandField ShowDeleteButton="True" />
            </Columns>
        </asp:GridView>
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 688px; position: absolute; top: 208px">Home</asp:LinkButton>
                        </form>
                </TD>
                <TD style="width: 2px"><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
          <TD style="background-image: url(images/but_bg.jpg); height: 5px; width: 792px;"><IMG height=5 src="images/spacer.gif" width=1></TD></TR>
        <TR>
          <TD style="background-image: url(images/but_bg.jpg); width: 792px;">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR>
                <TD background=images/footbg.jpg style="background-image: url(images/but_bg.jpg); height: 35px;">
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TBODY>
                    <TR>
                      ...
                      <TD class=footer style="background-image: url(images/but_bg.jpg)"><a href="Home.aspx"> Home </a> |Aboutus | About CIS | Samples | <a href="CustomerReg.aspx">
                        Register </a> | <a href="Info_Supplier.aspx">  Infosupply </a> | Contact Us</td></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></BODY></HTML>
