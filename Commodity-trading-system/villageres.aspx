<%@ Page Language="C#" AutoEventWireup="true" CodeFile="villageres.aspx.cs" Inherits="villageres" %>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp;
                       <asp:Button ID="btnYes" runat="server" Style="z-index: 101; left: 388px; position: absolute;
                           top: 263px" Text="Yes" OnClick="btnYes_Click" />
                       <asp:Button ID="btnHome" runat="server" Style="z-index: 102; left: 478px; position: absolute;
                           top: 264px" Text="Home" OnClick="btnHome_Click" />
                    <br />
                    <br />
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    <br />
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Do u want to Save another Record<br />
                    </form>
                </TD>
                ...
                <TD background=images/footbg.jpg height=42 style="background-image: url(images/but_bg.jpg)">
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD class=footer style="background-image: url(images/but_bg.jpg)"><a href="Home.aspx"> Home </a> |Aboutus | About CIS | 
                        Register | <a href="Info_Supplier.aspx">  Infosupply </a> | Contact</td></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></BODY></HTML>
