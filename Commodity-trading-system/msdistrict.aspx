<%@ Page Language="C#" AutoEventWireup="true" CodeFile="msdistrict.aspx.cs" Inherits="msdistrict" %>
...
>
    <asp:Label ID="Label2" runat="server" ForeColor="Red" Style="z-index: 100; left: 371px;
        position: absolute; top: 351px" Text="Label" Width="387px"></asp:Label>
<TABLE cellSpacing=0 cellPadding=0 align=center border=0 style="width: 825px">
  <TBODY>
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px; width: 787px;">
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 1931px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 558px; position: absolute; top: 183px"
                        Text="District Master" Width="108px" Font-Underline="True" TabIndex="8"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" ForeColor="Maroon" Style="z-index: 101; left: 471px;
                        position: absolute; top: 239px" Text="State ID *" TabIndex="5"></asp:Label>
                       &nbsp;
                       <asp:Label ID="Label4" runat="server" ForeColor="Maroon" Style="z-index: 102; left: 471px;
                           position: absolute; top: 263px" Text="District Name *" TabIndex="7" Width="103px"></asp:Label>
                       &nbsp;&nbsp; 
                       <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 320px; position: absolute; top: 182px">My Page</asp:HyperLink>
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:TextBox ID="txtDistName" runat="server" Style="z-index: 104; left: 585px; position: absolute;
                        top: 266px" Height="19px" Width="133px" TabIndex="2" MaxLength="25"></asp:TextBox>
                       &nbsp; &nbsp;
                       <asp:DropDownList ID="ddlStID" runat="server" Style="z-index: 105; left: 585px;
                           position: absolute; top: 238px" Width="134px">
                       </asp:DropDownList>
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 106; left: 586px; position: absolute;
                           top: 303px" Text="Submit" OnClick="btnSubmit_Click" TabIndex="3" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 107; left: 660px; position: absolute;
                           top: 303px" Text="Clear" OnClick="btnClear_Click" TabIndex="4" />
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDistName"
                           ErrorMessage="Enter District Name" Style="z-index: 109; left: 520px; position: absolute;
                           top: 382px" Width="201px"></asp:RequiredFieldValidator>
                        </form>
                </TD>
                <TD style="width: 46px"><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
