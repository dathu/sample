<%@ Page Language="C#" AutoEventWireup="true" CodeFile="msmandal.aspx.cs" Inherits="msmandal" %>
...
>
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 100;
        left: 335px; position: absolute; top: 177px" Width="77px">My Page</asp:HyperLink>
    <asp:Label ID="Label3" runat="server" ForeColor="Red" Style="z-index: 102; left: 345px;
        position: absolute; top: 361px" Text="Label" Width="390px"></asp:Label>
                ...
                <TD style="background-color: lemonchiffon">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 508px; position: absolute; top: 176px"
                        Text="Mandal Master" Width="110px" Font-Underline="True"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" ForeColor="Maroon" Style="z-index: 101; left: 440px;
                        position: absolute; top: 236px" Text="State ID *"></asp:Label>
                       <asp:Label ID="Label2" runat="server" ForeColor="Maroon" Style="z-index: 102; left: 440px;
                           position: absolute; top: 261px" Text="District ID *"></asp:Label>
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp;&nbsp;
                       <asp:DropDownList ID="ddlStID" runat="server" Style="z-index: 103; left: 554px; position: absolute;
                           top: 235px" Width="135px" Height="9px" AutoPostBack="True" OnSelectedIndexChanged="ddlStID_SelectedIndexChanged">
                       </asp:DropDownList>
                       <asp:DropDownList ID="ddlDistID" runat="server" Style="z-index: 104; left: 553px; position: absolute;
                           top: 261px" Width="135px">
                       </asp:DropDownList>
                       <asp:Label ID="Label7" runat="server" ForeColor="Maroon" Style="z-index: 105; left: 441px;
                           position: absolute; top: 288px" Text="Mandal Name *"></asp:Label>
                       <asp:TextBox ID="txtMndlName" runat="server" Style="z-index: 106; left: 553px; position: absolute;
                           top: 289px" Height="19px" Width="134px" MaxLength="25"></asp:TextBox>
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 107; left: 552px; position: absolute;
                           top: 325px" Text="Submit" OnClick="btnSubmit_Click" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 108; left: 627px; position: absolute;
                           top: 325px" Text="Clear" OnClick="btnClear_Click" />
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMndlName"
                           ErrorMessage="Enter Mandal Name" Style="z-index: 110; left: 528px; position: absolute;
                           top: 394px" Width="192px"></asp:RequiredFieldValidator>
                        </form>
                </TD>
                <TD width=14><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
