<%@ Page Language="C#" AutoEventWireup="true" CodeFile="categoryview.aspx.cs" Inherits="categoryview" %>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="Edit / View   Category" Width="147px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT [CommID], [CatID], [Name1] FROM [Comm_Mast] WHERE ([Comm_Div_TypeID] = @Comm_Div_TypeID)" DeleteCommand="DELETE FROM Comm_Mast WHERE (CommID = @CommID)" UpdateCommand="UPDATE Comm_Mast SET CatID = @CatID, Name1 = @Name1 WHERE (CommID = @CommID)">
            <SelectParameters>
                <asp:Parameter DefaultValue="1" Name="Comm_Div_TypeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CommID"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 325px; position: absolute;
            top: 225px" Width="415px">
            <Columns>
                ...
                <asp:CommandField ShowDeleteButton="True" />
                       ...
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 686px; position: absolute; top: 202px">Home</asp:LinkButton>
                        </form>
                </TD>
