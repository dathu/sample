<%@ Page Language="C#" AutoEventWireup="true" CodeFile="typeview.aspx.cs" Inherits="typeview" %>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 606px;">&nbsp;
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT [CommID], [CatID], [NameID], [TypeID], [Name1] FROM [Comm_Mast] WHERE ([Comm_Div_TypeID] = @Comm_Div_TypeID)" DeleteCommand="DELETE FROM Comm_Mast WHERE (CommID = @CommID)" UpdateCommand="UPDATE Comm_Mast SET CatID = @CatID, NameID = @NameID, TypeID = @TypeID, Name1 = @Name1 WHERE (CommID = @CommID)">
            <SelectParameters>
                <asp:Parameter DefaultValue="3" Name="Comm_Div_TypeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="Edit / View  Type" Width="133px" Font-Underline="True" TabIndex="6"></asp:Label>&nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 377px; position: absolute;
            top: 221px" AllowPaging="True" DataKeyNames="CommID">
             <Columns>
                 <asp:BoundField DataField="CommID" HeaderText="CommID" ReadOnly="True" SortExpression="CommID" />
             ...
             <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 758px; position: absolute; top: 196px">Home</asp:LinkButton>
                        </form>
                </TD>
