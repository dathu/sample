<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Market_Commodity.aspx.cs" Inherits="Market_Commodity" %>
...
>
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 100;
        left: 315px; position: absolute; top: 170px">My Page</asp:HyperLink>
                ...
                <TD style="background-color: lemonchiffon; width: 580px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="MARKET   COMMODITY" Width="185px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; 
                      <asp:Button ID="btnAdd" runat="server" Style="z-index: 101; left: 480px; position: absolute;
                          top: 317px" Text="Add   >>" Width="69px" OnClick="btnAdd_Click" />
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                      <asp:Label ID="Label11" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 102;
                          left: 374px; position: absolute; top: 274px" Text="Commodity" Width="84px"></asp:Label>
                      <asp:Label ID="Label2" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 112;
                          left: 372px; position: absolute; top: 439px" Text="Market's  Commodity Measurement"
                          Width="146px"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp;&nbsp;
                      <asp:Label ID="Label16" runat="server" ForeColor="Navy" Height="15px" Style="z-index: 104;
                          left: 375px; position: absolute; top: 238px" Text="Market Name" Width="89px"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                      <asp:DropDownList ID="ddlMarketName" runat="server" Style="z-index: 105; left: 541px; position: absolute;
                          top: 240px" Width="129px" Height="22px">
                          <asp:ListItem></asp:ListItem>
                      </asp:DropDownList>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                      <asp:ListBox ID="lbCommNew" runat="server" Height="117px" Style="z-index: 106; left: 557px;
                          position: absolute; top: 305px" Width="111px" SelectionMode="Multiple"></asp:ListBox>
                      <asp:ListBox ID="lbCommOld" runat="server" Height="117px" Style="z-index: 107; left: 363px;
                          position: absolute; top: 302px" Width="111px" SelectionMode="Multiple"></asp:ListBox>
                      <asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Style="z-index: 108;
                          left: 539px; position: absolute; top: 491px" Text="Submit" />
                      <asp:Button ID="btnCancel" runat="server" Style="z-index: 109; left: 616px; position: absolute;
                          top: 491px" Text="Cancel" OnClick="btnCancel_Click" />
                      <asp:Button ID="btnDelete" runat="server" Style="z-index: 110; left: 480px; position: absolute;
                          top: 381px" Text=">> Delete" Width="70px" OnClick="btnDelete_Click" />
                      &nbsp;
                      <asp:TextBox ID="txtMrkCommMsr" runat="server" Height="22px" Style="z-index: 111; left: 537px;
                          position: absolute; top: 443px" Width="129px"></asp:TextBox>
                </form>
                </TD>
