<%@ Page Language="C#" AutoEventWireup="true" CodeFile="msvillage.aspx.cs" Inherits="msvillage" %>
...
>
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 100;
        left: 336px; position: absolute; top: 173px">My Page</asp:HyperLink>
    <asp:Label ID="Label4" runat="server" ForeColor="Red" Style="z-index: 102; left: 378px;
        position: absolute; top: 397px" Text="Label" Width="382px"></asp:Label>
                ...
                <TD style="background-color: lemonchiffon">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 508px; position: absolute; top: 184px"
                        Text="Village Master" Width="110px" Font-Underline="True"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label6" runat="server" ForeColor="Maroon" Style="z-index: 101; left: 442px;
                        position: absolute; top: 237px" Text="State ID *"></asp:Label>
                       <asp:Label ID="Label2" runat="server" ForeColor="Maroon" Style="z-index: 102; left: 441px;
                           position: absolute; top: 263px" Text="District ID *"></asp:Label>
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp;&nbsp;
                       <asp:DropDownList ID="ddlStID" runat="server" Style="z-index: 103; left: 552px; position: absolute;
                           top: 235px" Width="135px" Height="9px" AutoPostBack="True" OnSelectedIndexChanged="ddlStID_SelectedIndexChanged">
                       </asp:DropDownList>
                       <asp:DropDownList ID="ddlDistID" runat="server" Style="z-index: 104; left: 551px; position: absolute;
                           top: 261px" Width="135px" Height="9px" AutoPostBack="True" OnSelectedIndexChanged="ddlDistID_SelectedIndexChanged">
                       </asp:DropDownList>
                       <asp:Label ID="Label7" runat="server" ForeColor="Maroon" Style="z-index: 105; left: 440px;
                           position: absolute; top: 317px" Text="Village  Name *"></asp:Label>
                       <asp:TextBox ID="txtVillName" runat="server" Style="z-index: 106; left: 551px; position: absolute;
                           top: 315px" Height="20px" Width="135px" MaxLength="25"></asp:TextBox>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtVillName"
                           ErrorMessage="Enter Village Name" Style="z-index: 112; left: 501px; position: absolute;
                           top: 427px" Width="216px"></asp:RequiredFieldValidator>
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 108; left: 552px; position: absolute;
                           top: 354px" Text="Submit" OnClick="btnSubmit_Click" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 109; left: 627px; position: absolute;
                           top: 354px" Text="Clear" OnClick="btnClear_Click" />
                       <asp:Label ID="Label3" runat="server" ForeColor="Maroon" Style="z-index: 110; left: 441px;
                           position: absolute; top: 291px" Text="Mandal ID *"></asp:Label>
                       <asp:DropDownList ID="ddlMndlID" runat="server" Height="9px" Style="z-index: 111;
                           left: 551px; position: absolute; top: 288px" Width="135px">
                       </asp:DropDownList>
                        </form>
                </TD>
                <TD width=14><IMG height=1 src="images/spacer.gif" 
