<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stateview.aspx.cs" Inherits="stateview" %>
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="Edit / View   State " Width="126px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
            ...
            DeleteCommand="delete from Loc_Mast where LocID=@LocID" SelectCommand="SELECT [LocID], [StateID], [Name1] FROM [Loc_Mast] WHERE ([Loc_TypeID] = @Loc_TypeID)"
            UpdateCommand="update Loc_Mast set StateID=@StateID,Name1=@Name1 where LocID=@LocID">
            <SelectParameters>
                <asp:Parameter DefaultValue="1" Name="Loc_TypeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="LocID"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 404px; position: absolute;
            top: 231px" AllowPaging="True">
            <Columns>
                ...
                <asp:CommandField ShowDeleteButton="True" />
                       ...
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 644px; position: absolute; top: 209px">Home</asp:LinkButton>
                        </form>
                </TD>
