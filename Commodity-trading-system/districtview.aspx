<%@ Page Language="C#" AutoEventWireup="true" CodeFile="districtview.aspx.cs" Inherits="districtview" %>
                ...
                <TD style="background-color: lemonchiffon; width: 606px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="Edit / View   District " Width="126px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>"
            DeleteCommand="delete from Loc_Mast where LocID=@LocID" SelectCommand="SELECT [LocID], [StateID], [DistID], [Name1] FROM [Loc_Mast] WHERE ([Loc_TypeID] = @Loc_TypeID)"
            UpdateCommand="update Loc_Mast set StateID=@StateID,Name1=@Name1 where LocID=@LocID">
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="Loc_TypeID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="LocID"
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 371px; position: absolute;
            top: 219px" AllowPaging="True">
            <Columns>
                ...
                <asp:CommandField ShowDeleteButton="True" />
                       ...
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/AdminHome.aspx" Style="z-index: 103;
                           left: 683px; position: absolute; top: 196px">Home</asp:LinkButton>
                        </form>
                </TD>
