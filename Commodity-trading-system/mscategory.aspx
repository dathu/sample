<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mscategory.aspx.cs" Inherits="mscategory" %>
...
>
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 100;
        left: 329px; position: absolute; top: 174px">My Page</asp:HyperLink>
    <asp:Label ID="Label2" runat="server" ForeColor="Red" Style="z-index: 102; left: 369px;
        position: absolute; top: 360px" Text="Label" Width="362px"></asp:Label>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        ...
                        Text="Category  Master" Width="119px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
                       <asp:Label ID="Label4" runat="server" ForeColor="Maroon" Style="z-index: 101; left: 415px;
                           position: absolute; top: 267px" Text="Category  Name *" TabIndex="5"></asp:Label>
                       &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:TextBox ID="txtCatName" runat="server" Style="z-index: 102; left: 534px; position: absolute;
                        top: 266px" Height="19px" Width="131px" TabIndex="1"></asp:TextBox>
                       &nbsp; &nbsp;
                       &nbsp; &nbsp;
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 103; left: 535px; position: absolute;
                           top: 319px" Text="Submit" OnClick="btnSubmit_Click" TabIndex="2" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 104; left: 609px; position: absolute;
                           top: 319px" Text="Clear" OnClick="btnClear_Click" TabIndex="3" />
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCatName"
                           ErrorMessage="Enter Category Name" Style="z-index: 106; left: 456px; position: absolute;
                           top: 392px" Width="142px"></asp:RequiredFieldValidator>
                        </form>
                </TD>
