<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mscity.aspx.cs" Inherits="mscity" %>
...
>
    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/AdminHome.aspx" Style="z-index: 100;
        left: 353px; position: absolute; top: 180px">My Page</asp:HyperLink>
   
<TABLE cellSpacing=0 cellPadding=0 width=775 align=center border=0>
  <TBODY>
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px; width: 733px;">
...
border=0>
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">&nbsp;
                   <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 463px; position: absolute; top: 176px"
                        Text="City  Master" Width="92px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
                       <asp:Label ID="Label4" runat="server" ForeColor="Maroon" Style="z-index: 101; left: 441px;
                           position: absolute; top: 267px" Text="City  Name  *" TabIndex="5"></asp:Label>
                       &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                    <asp:TextBox ID="txtCityName" runat="server" Style="z-index: 102; left: 534px; position: absolute;
                        top: 265px" Height="19px" Width="131px" TabIndex="1"></asp:TextBox>
                       &nbsp; &nbsp;
                       &nbsp; &nbsp;
                       <asp:Button ID="btnSubmit" runat="server" Style="z-index: 103; left: 534px; position: absolute;
                           top: 324px" Text="Submit" OnClick="btnSubmit_Click" TabIndex="2" />
                       <asp:Button ID="btnClear" runat="server" Style="z-index: 104; left: 612px; position: absolute;
                           top: 323px" Text="Clear" OnClick="btnClear_Click" TabIndex="3" />
                       <asp:Label ID="Label2" runat="server" ForeColor="Maroon" Style="z-index: 105; left: 440px;
                           position: absolute; top: 244px" TabIndex="4" Text="City ID *"></asp:Label>
                       <asp:Label ID="Label3" runat="server" ForeColor="Red" Style="z-index: 111; left: 393px;
                           position: absolute; top: 208px" Text="Label" Width="314px"></asp:Label>
                       <asp:TextBox ID="txtCityID" runat="server" Height="19px" Style="z-index: 107; left: 534px;
                           position: absolute; top: 242px" Width="131px"></asp:TextBox>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCityName"
                           ErrorMessage="Enter City Name" Style="z-index: 108; left: 514px; position: absolute;
                           top: 365px" Width="144px"></asp:RequiredFieldValidator>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtCityID"
                           ErrorMessage="Enter City Id" Style="z-index: 109; left: 498px; position: absolute;
                           top: 421px" Width="178px"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtCityID"
        ErrorMessage="City Id Should be Numeric" Style="z-index: 110; left: 449px; position: absolute;
        top: 394px" ValidationExpression="\d{1,20}" Width="229px"></asp:RegularExpressionValidator>
                        </form>
                </TD>
                <TD style="width: 2px"><IMG height=1 src="images/spacer.gif" 
                  width=1></TD></TR></TBODY></TABLE></TD></TR>
        <TR>
