  ...
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px;">
      ...
      background="images/headbg.jpg" border=0>
        <TBODY>
        <TR>
          <TD width=224 style="background-image: url(images/headbg.jpg); height: 46px;">
          ...
          <TD width=537 style="background-image: url(images/headbg.jpg); height: 46px;">&nbsp;</TD>
          <TD width=14 style="height: 46px"><IMG height=1 src="images/spacer.gif" 
        ...
        <TR>
          <TD style="height: 492px">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR vAlign=top>
                <TD width=180 background="images/but_bg.jpg" height="473" style="background-image: url(images/but_bg.jpg)">
                ...
                <TD style="background-color: lemonchiffon; width: 558px;">&nbsp;
                  <form id="Form1" runat="server">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="19px" Style="z-index: 100; left: 391px; position: absolute; top: 190px"
                        Text="CUSTOMER Home Page" Width="179px" Font-Italic="False"></asp:Label>
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                      <table style="z-index: 100; left: 269px; width: 380px; position: absolute; top: 250px;
                          height: 195px">
                          <tr>
                              <td style="width: 9px; height: 37px">
                              </td>
                              <td style="width: 100px; height: 37px">
                                  <asp:HyperLink ID="HyperLink1" runat="server" Style="z-index: 100; left: 52px; position: absolute;
                                      top: 17px" NavigateUrl="~/Search1.aspx" Width="320px">Commodity wise Market wise Price Search</asp:HyperLink>
                                  
                              </td>
                          </tr>
                          <tr>
                              <td style="width: 9px; height: 58px">
                              </td>
                          ...
                          <tr>
                              <td style="width: 9px; height: 58px">
                              <asp:HyperLink ID="HyperLink2" runat="server" Style="z-index: 102; left: 53px; position: absolute;
                                      top: 196px">Reports</asp:HyperLink>
                              </td>
                              <td style="width: 100px; height: 58px">
                                  <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                                      Style="z-index: 100; left: 116px; position: absolute; top: 196px" Width="218px">
                                  ...
                                  <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Style="z-index: 101;
                                      left: 258px; position: absolute; top: 239px" Text="Show Report" />
                                  <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/SearchMinPrice.aspx"
                                      Style="z-index: 102; left: 55px; position: absolute; top: 64px" Width="264px">Search Commodity wise Min Price </asp:HyperLink>
                                  <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/SearchMaxPrice.aspx"
                                      Style="z-index: 104; left: 56px; position: absolute; top: 122px" Width="277px">Search Commodity wise Maximum Price</asp:HyperLink>
                              </td>
                          </tr>
                          <tr>
                              <td style="width: 9px; height: 117px">
                              </td>
                ...
                <TD background=images/footbg.jpg height=42 style="background-image: url(images/but_bg.jpg)">
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      <TD class=footer style="background-image: url(images/but_bg.jpg)">
                      <a href="Home.aspx">
                      Home </a>|Aboutus | About CIS | Samples | <a href="CustomerReg.aspx">
                        Register</a> | <a href="Info_Supplier.aspx">
                        Infosupply </a> | 
