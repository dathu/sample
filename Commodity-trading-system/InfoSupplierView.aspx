<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InfoSupplierView.aspx.cs" Inherits="InfoSupplierView" %>
...
>
<TABLE cellSpacing=0 cellPadding=0 width="2000" align=center border=0>
  <TBODY>
  <TR>
    <TD style="background-image: url(images/bg.jpg); height: 144px; width: 767px;">
  ...
  <TR>
    <TD style="width: 767px">
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD style="height: 492px; width: 2000px;">
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TBODY>
              <TR vAlign=top>
...
border=0>
                          ...
                          <%--<TR>
                            <TD vAlign=bottom height=31><IMG height=28 
                              src="images/bullet.jpg" width=26></TD>
                            <TD><A 
                              onmouseover="MM_swapImage('Image5','','images/tariff_hov.jpg',1)" 
                              onmouseout=MM_swapImgRestore() 
                              href="file:///C:/Documents%20and%20Settings/admin/Desktop/CIS/cis%20html/innerpage.htm#"><IMG 
                              id=Image5 height=31 
                              src="images/tariff.jpg" width=139 
                              border=0 name=Image5></A></TD></TR>--%>
                          <%--<TR>
                            <TD vAlign=bottom height=31><IMG height=28 
                              src="images/bullet.jpg" width=26></TD>
                            <TD><A 
                              onmouseover="MM_swapImage('Image6','','images/trading_hov.jpg',1)" 
                              onmouseout=MM_swapImgRestore() 
                              href="file:///C:/Documents%20and%20Settings/admin/Desktop/CIS/cis%20html/innerpage.htm#"><IMG 
                              id=Image6 height=31 
                              src="images/trading.jpg" width=139 
                              border=0 name=Image6></A></TD></TR>--%>
                          <TR>
                            <TD vAlign=bottom height=32><IMG height=28 
                              src="images/bullet.jpg" width=26></TD>
                            <TD><A 
                ...
                <TD style="background-color: lemonchiffon; width: 583px;">&nbsp;
                   <form id="Form1" runat="server" style="width: 2000px">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"
                        Height="21px" Style="z-index: 100; left: 501px; position: absolute; top: 161px"
                        Text="Edit / View   Info Supplier" Width="164px" Font-Underline="True" TabIndex="6"></asp:Label>
                    &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       &nbsp;
            ...
            DataSourceID="SqlDataSource1" Style="z-index: 101; left: 188px; position: absolute;
            top: 285px">
            <Columns>
                <asp:BoundField DataField="Infosup_id" HeaderText="Infosup_id" ReadOnly="True" SortExpression="Infosup_id" />
                ...
                <asp:BoundField DataField="Mother_Tongue" HeaderText="Mother_Tongue" SortExpression="Mother_Tongue" />
                <asp:BoundField DataField="Occupation" HeaderText="Occupation" SortExpression="Occupation" />
                <asp:BoundField DataField="Biz_Category" HeaderText="Biz_Category" SortExpression="Biz_Category" />
                <asp:BoundField DataField="Joining_Dt" HeaderText="Joining_Dt" SortExpression="Joining_Dt" />
                <asp:BoundField DataField="Qualif" HeaderText="Qualif" SortExpression="Qualif" />
                <asp:BoundField DataField="Payment" HeaderText="Payment" SortExpression="Payment" />
                <asp:BoundField DataField="End_Dt" HeaderText="End_Dt" SortExpression="End_Dt" />
            </Columns>
        </asp:GridView>
                       <asp:LinkButton ID="lbHome" runat="server" PostBackUrl="~/Info_Supplier.aspx" Style="z-index: 103;
                           left: 883px; position: absolute; top: 207px">Back</asp:LinkButton>
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cisConnectionString %>" SelectCommand="SELECT * FROM [Info_Supplier]"></asp:SqlDataSource>
                        </form>
                </TD>
