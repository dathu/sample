...
border=0>
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                      <asp:Panel ID="Panel2" runat="server" Height="48px" Style="z-index: 102; left: 322px;
        position: absolute; top: 276px" Width="422px">
                              ...
                              <tr>
                                  <td style="width: 100px; height: 26px">
                                      <asp:Label ID="Label6" runat="server" Style="z-index: 100; left: 0px; position: absolute;
                                          top: 0px" Text="Market  * "></asp:Label>
                                  </td>
                                  <td style="width: 172px; height: 26px">
                                      <asp:DropDownList ID="Ddlmarket" runat="server" Style="z-index: 100; left: 110px;
                                          position: absolute; top: 3px" Width="162px">
                                      </asp:DropDownList>
                                  </td>
                                  <td style="width: 100px; height: 26px">
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtdate"
                                          ErrorMessage="Date Should not  be  empty" Style="z-index: 100; left: 385px; position: absolute;
                                          top: 64px" Width="184px"></asp:RequiredFieldValidator>
                                  </td>
                              </tr>
                          </table>
                      </asp:Panel>
                      
                       <table style="z-index: 102; left: 323px; position: absolute; top: 328px">
                  <tr>
                      <td style="width: 53px; height: 26px">
                          <asp:Label ID="Label10" runat="server" Style="z-index: 100; left: 8px; position: absolute;
                              top: 1px" Text="Date *"></asp:Label>
                      </td>
                      ...
                      <asp:Calendar ID="Calendar1" runat="server" Style="z-index: 103; left: 628px; position: absolute;
                      ...
                      <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Style="z-index: 104;
                          left: 584px; position: absolute; top: 340px" Text="Show Price" />
                      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" Style="z-index: 105;
                          left: 314px; position: absolute; top: 379px" Width="600px">
                      </asp:GridView>
                      <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/CustomerHome.aspx" Style="z-index: 107;
